...
import { processPreKeyMessage, processRegularMessage } from "./functions";
...
export function sendSignalProtocolMessage(
  to: string,
  from: string,
  message: MessageType
): void {
